...
export default function PaymentFailed() {
    ...
    return (
      ...
      >
        <Content style={{ padding: 32, textAlign: 'center' }}>
          ...
          <Button type="primary" onClick={() => navigate('/pay')}>
            Back to Payments
          </Button>
        </Content>
      </Layout>
  ...
  return (
    <ConfigProvider
      theme={{
        token: { colorPrimary: '#ff4d4f', borderRadius: 12, fontSize: 14 },
      }}
    >
      <Layout
        style={{
              ...
              <Descriptions
                ...
                items={[
                  ...
                  },
                  {
                    key: 'time',
                    label: 'Attempt Time',
                    children: safeDateTime(data.paidAt),
                  },
                  {
                    key: 'method',
